...
add_custom_target(debug-server 
	COMMAND JLinkGDBServer -device ${CPU_FAMILY_L} -speed 4000 -if SWD
	DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}.bin
	)

add_custom_target(flash 
	COMMAND JLinkExe -device ${CPU_FAMILY_L} -speed 4000 -if SWD -CommanderScript ${CMAKE_CURRENT_BINARY_DIR}/flash.jlink 
	DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}.bin
	)

add_custom_target(flash-softdevice 
	COMMAND JLinkExe -device ${CPU_FAMILY_L} -speed 4000 -if SWD -CommanderScript ${CMAKE_CURRENT_BINARY_DIR}/flash-softdevice.jlink 
	DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${TARGET}.bin
	)

add_custom_target(erase 
	COMMAND JLinkExe -device ${CPU_FAMILY_L} -speed 4000 -if SWD -CommanderScript ${CMAKE_CURRENT_LIST_DIR}/erase.jlink 
	)

add_custom_target(reset 
	COMMAND JLinkExe -device ${CPU_FAMILY_L} -speed 4000 -if SWD -CommanderScript ${CMAKE_CURRENT_LIST_DIR}/reset.jlink 
	)
